package com.village.joinalong.messaging;
...
import com.village.joinalong.ui.WelcomeActivity;
...
public class JoinAlongFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String notificationId, String eventId, String sender, String type, String title) {
        ...
        if (notificationPref) {
            ...
            Cursor cursor = readNotificationFromDataBase(NotificationLoader.Query.PROJECTION, null, null, null);
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (cursor.getString(NotificationLoader.Query.COLUMN_TYPE).equals("New")) {
                        messageBody = getString(R.string.summary_notification_new_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE));
                        notificationStyle.addLine(getString(R.string.summary_notification_new_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE)));
                    } else if (cursor.getString(NotificationLoader.Query.COLUMN_TYPE).equals("Update")) {
                        messageBody = getString(R.string.summary_notification_update_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE));
                        notificationStyle.addLine(getString(R.string.summary_notification_update_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE)));
                    } else if (cursor.getString(NotificationLoader.Query.COLUMN_TYPE).equals("Delete")) {
                        messageBody = getString(R.string.summary_notification_delete_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE));
                        notificationStyle.addLine(getString(R.string.summary_notification_delete_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE)));
                    }else if (cursor.getString(NotificationLoader.Query.COLUMN_TYPE).equals("Join")){
                        messageBody = getString(R.string.summary_notification_join_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE));
                        notificationStyle.addLine(getString(R.string.summary_notification_join_event,cursor.getString(NotificationLoader.Query.COLUMN_SENDER),cursor.getString(NotificationLoader.Query.COLUMN_EVENT_TITLE)));
                    }
