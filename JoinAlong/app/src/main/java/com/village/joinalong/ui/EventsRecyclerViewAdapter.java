...
public class EventsRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        if (viewType ==-1){
            ...
            EventsRecyclerViewAdapter.ViewHolder vh = new EventsRecyclerViewAdapter.ViewHolder(view, new ViewHolder.ViewHolderClicks() {
                ...
                public void onJoin(int pos) {
                    ...
                    users.add(mEventList.get(pos).getOwnerId());
                    NotificationUtil.sendEventNotification(eventId, firebaseUser.getDisplayName(),"Join",mEventList.get(pos).getTitle(),users);
                }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder.getItemViewType()==-1){
            ...
            if (statusarray[1].equals("1")) {
                ...
                viewHolder.mJoinCheckBox.setChecked(true);
                joinFlag = true;
                //viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.colorLightPrimary));
            }
            else {
                //viewHolder.mJoinButton.setText(R.string.join_button_text);
                viewHolder.mJoinCheckBox.setChecked(false);
                //viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.colorBackground));
                joinFlag = false;
            }
            ...
            if (eventNotificationMap.containsKey(mEventList.get(position).getEventId())) {
               // viewHolder.mNotification.setVisibility(View.VISIBLE);
                ...
                viewHolder.mOwner.setTypeface(null, Typeface.BOLD);
                viewHolder.mTitleView.setTypeface(null, Typeface.BOLD);
                //viewHolder.mLocationView.setTypeface(null, Typeface.BOLD);
                //viewHolder.mDate.setTypeface(null, Typeface.BOLD);
                //viewHolder.mTime.setTypeface(null, Typeface.BOLD);
                //viewHolder.mPeople.setTypeface(null, Typeface.BOLD);

            }else{
                viewHolder.mNotification.setVisibility(View.GONE);
                viewHolder.mOwner.setTypeface(null, Typeface.NORMAL);
                viewHolder.mTitleView.setTypeface(null, Typeface.NORMAL);
                //viewHolder.mLocationView.setTypeface(null, Typeface.NORMAL);
                //viewHolder.mDate.setTypeface(null, Typeface.NORMAL);
                //viewHolder.mTime.setTypeface(null, Typeface.NORMAL);
                //viewHolder.mPeople.setTypeface(null, Typeface.NORMAL);
            }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View view, ViewHolderClicks clickListener) {
            ...
            mJoinCheckBox = (CheckBox) view.findViewById(R.id.join_check_box);
